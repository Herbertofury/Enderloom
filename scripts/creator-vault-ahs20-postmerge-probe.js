...
const ids = new Set(['youtube:eJy6KJj8_m0','youtube:W_Q6Vg-HtMM']);
...
if (freshVideos.length !== 2 || freshMods.length !== 19 || freshMods.some(mod => !(mod.providerLinks||[]).length) || freshMods.some(mod => mod.timestampSeconds !== null)) process.exitCode = 2;

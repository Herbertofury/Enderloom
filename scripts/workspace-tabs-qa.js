...
assert(launcherPreload.includes("ipcRenderer.invoke('launcher:provider-surface'")&&project.includes('application/x-enderloom-provider-page')&&project.includes('providerSurfaceState?.url')&&project.includes('SquareArrowOutUpRight'),'launcher provider pane/promote controls are not wired end to end');

...
const main=read('main.js'),shell=read('shell.js'),html=read('shell.html'),detached=read('detached.html'),preload=read('detached-preload.js'),launcherPreload=read('launcher-preload.js'),project=read('launcher/src/views/ProjectView.tsx'),home=read('launcher/src/views/HomeView.tsx'),sidebar=read('launcher/src/components/Sidebar.tsx'),viewModules=read('launcher/src/lib/view-modules.ts'),runScript=read('scripts/run.js'),service=read('native/src/service.rs');
...
console.log(JSON.stringify({passed:true,dragReorder:true,providerPromotion:true,providerPane:true,groups:true,detachReattach:true,fullscreen:true,compactManager:true,deferredWorkspaces:true,visibleMediaOnly:true}));

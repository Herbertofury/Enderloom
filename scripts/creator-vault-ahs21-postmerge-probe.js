...
const ids = new Set(['youtube:7Yr4KIjdWcE','youtube:rYXEREsiGrE']);
...
if (freshVideos.length !== 2 || freshMods.length !== 11 || freshMods.some(mod => !(mod.providerLinks||[]).length) || freshMods.some(mod => mod.timestampSeconds !== null)) process.exitCode = 2;

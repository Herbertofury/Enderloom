...
const research = require('../catalog/creator-vault/research/asianhalfsquat.chunk25-source.json');
...
if (vault.stats.uniqueProjects !== 573 || vault.stats.recommendations !== 794 || research.videos.length !== 1 || rows.length !== 10) process.exitCode = 2;

...
const candidates = require('../catalog/creator-vault/research/asianhalfsquat.chunk20-provider-candidates.json');
...
if ((candidates.entries||[]).length !== 12 || destinations !== 23 || collisions.length) process.exitCode = 2;

...
const ids = new Set(['youtube:cjD9jYsfNj8','youtube:OMnbxkBp_0c']);
...
if (freshVideos.length !== 2 || freshMods.length !== 15 || freshMods.some(mod => !(mod.providerLinks||[]).length)) process.exitCode = 2;

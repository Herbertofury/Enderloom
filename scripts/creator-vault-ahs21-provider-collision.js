...
const candidates = require('../catalog/creator-vault/research/asianhalfsquat.chunk21-provider-candidates.json');
...
if ((candidates.entries||[]).length !== 7 || destinations !== 8 || collisions.length) process.exitCode = 2;

...
const candidates = require('../catalog/creator-vault/research/asianhalfsquat.chunk22-provider-candidates.json');
...
if ((candidates.entries||[]).length !== 21 || destinations !== 43 || collisions.length) process.exitCode = 2;

...
if(from&&!scripts.includes(from)){console.error(`Unknown starting suite: ${from}`);process.exit(2);}
...
console.log(JSON.stringify({passed:true,from:from||null,suites:results.map(x=>x.script)},null,2));

...
const research = require('../catalog/creator-vault/research/asianhalfsquat.chunk23-source.json');
...
if (vault.stats.uniqueProjects !== 572 || vault.stats.recommendations !== 781 || research.videos.length !== 1 || rows.length !== 8) process.exitCode = 2;

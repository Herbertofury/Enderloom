...
const candidates = require('../catalog/creator-vault/research/asianhalfsquat.chunk19-provider-candidates.json');
...
if ((candidates.entries||[]).length !== 18 || destinations !== 49 || collisions.length) process.exitCode = 2;

...
const research = require('../catalog/creator-vault/research/asianhalfsquat.chunk20-source.json');
...
if (vault.stats.uniqueProjects !== 544 || vault.stats.recommendations !== 720 || research.videos.length !== 2 || rows.length !== 19) process.exitCode = 2;

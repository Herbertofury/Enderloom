...
> One checkbox owns each complete capability. Its acceptance and linked source clauses are binding together.
...
- [ ] **AOA-01 - Source lineage and original identity**
  ...
  - **State:** unverified. **Details:** [649 source blocks](Sources-AOA.md#aoa-01); 31 source documents.
...
- [ ] **AOA-02 - Complete semantic port**
  ...
  - **State:** unverified. **Details:** [85 source blocks](Sources-AOA.md#aoa-02); 27 source documents.
...
- [ ] **AOA-04 - Native gameplay and migration proof**
  ...
  - **State:** unverified. **Details:** [69 source blocks](Sources-AOA.md#aoa-04); 21 source documents.
...
- [ ] **UX-01 - Four-action Home**
  ...
  - **State:** unverified. **Details:** [64 source blocks](Sources-UX.md#ux-01); 17 source documents.
...
- [ ] **UX-07 - Large-data and bulk usability**
  ...
  - **State:** unverified. **Details:** [56 source blocks](Sources-UX.md#ux-07); 12 source documents.
...
- [ ] **UX-08 - Accessible responsive native UI**
  ...
  - **State:** unverified. **Details:** [103 source blocks](Sources-UX.md#ux-08); 19 source documents.
...
- [ ] **MAKE-09 - Reference and concept reconstruction**
  ...
  - **State:** unverified. **Details:** [111 source blocks](Sources-MAKE.md#make-09); 13 source documents.
...
- [ ] **PORT-01 - Input and source authority**
  ...
  - **State:** unverified. **Details:** [196 source blocks](Sources-PORT.md#port-01); 26 source documents.
...
- [ ] **PORT-05 - Source migration and semantic repair**
  ...
  - **State:** unverified. **Details:** [130 source blocks](Sources-PORT.md#port-05); 29 source documents.
...
- [ ] **TEST-01 - Deterministic test sandbox**
  ...
  - **State:** unverified. **Details:** [597 source blocks](Sources-TEST.md#test-01); 25 source documents.
...
- [ ] **PERF-01 - Real mod and instance optimization**
  ...
  - **State:** unverified. **Details:** [146 source blocks](Sources-PERF.md#perf-01); 19 source documents.
...
- [ ] **PERF-07 - Fast conversion and responsive studio**
  ...
  - **State:** unverified. **Details:** [7 source blocks](Sources-PERF.md#perf-07); 6 source documents.
...
- [ ] **LIB-01 - Broad source-aware discovery**
  ...
  - **State:** unverified. **Details:** [74 source blocks](Sources-LIB.md#lib-01); 15 source documents.
...
- [ ] **LIB-02 - Correct premium media and trailers**
  ...
  - **State:** unverified. **Details:** [49 source blocks](Sources-LIB.md#lib-02); 13 source documents.
...
- [ ] **LIB-03 - Real embedded browser**
  ...
  - **State:** unverified. **Details:** [83 source blocks](Sources-LIB.md#lib-03); 11 source documents.
...
- [ ] **LIB-04 - Catalog-to-instance bridge**
  ...
  - **State:** unverified. **Details:** [72 source blocks](Sources-LIB.md#lib-04); 21 source documents.
...
- [ ] **LIB-05 - Dedicated Favorites workspace**
  ...
  - **State:** unverified. **Details:** [155 source blocks](Sources-LIB.md#lib-05); 8 source documents.
...
- [ ] **LIB-06 - Content lifecycle and provenance**
  ...
  - **State:** unverified. **Details:** [130 source blocks](Sources-LIB.md#lib-06); 25 source documents.
...
- [ ] **LIB-07 - Exact versions, freeze and upgrades**
  ...
  - **State:** unverified. **Details:** [19 source blocks](Sources-LIB.md#lib-07); 9 source documents.
...
- [ ] **LIB-08 - Provider downloads and account recovery**
  ...
  - **State:** unverified. **Details:** [89 source blocks](Sources-LIB.md#lib-08); 14 source documents.
...
- [ ] **LIB-09 - Pack and research interchange**
  ...
  - **State:** unverified. **Details:** [128 source blocks](Sources-LIB.md#lib-09); 17 source documents.
...
- [ ] **PLAY-06 - Native sharing and pack distribution**
  ...
  - **State:** unverified. **Details:** [22 source blocks](Sources-PLAY.md#play-06); 16 source documents.
...
- [ ] **SHIP-01 - Supply-chain and untrusted input safety**
  ...
  - **State:** unverified. **Details:** [143 source blocks](Sources-SHIP.md#ship-01); 27 source documents.

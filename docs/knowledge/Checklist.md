...
**Edit progress:** use the [record command](Working-Agreement.md#record-progress) or the canonical `requirements.json` ledger. Do not independently tick the Wiki, edit generated pages, or check an outcome because its heading sounds implemented.

**[Ad-free mod images](Media-Integrity.md) / [Site adapters](Site-Adapters.md) / [Browser and translation](Browser-and-Translation.md) / [Every detailed source requirement](Detailed-Acceptance.md)**
...
**[Open 281 detailed checks](Acceptance-AOA.md#aoa-01-details)**
...
- [ ] **AOA-01 - Source lineage and original identity**
  ...
  - **State:** unverified. **Details:** [651 source blocks](Sources-AOA.md#aoa-01); 32 source documents.

**[Open 25 detailed checks](Acceptance-AOA.md#aoa-02-details)**
...
- [ ] **AOA-02 - Complete semantic port**
  ...
  - **State:** unverified. **Details:** [87 source blocks](Sources-AOA.md#aoa-02); 28 source documents.

**[Open 25 detailed checks](Acceptance-AOA.md#aoa-03-details)**
...
- [ ] **AOA-03 - Complete gameplay and assets**
  ...
  - **State:** unverified. **Details:** [77 source blocks](Sources-AOA.md#aoa-03); 14 source documents.

**[Open 22 detailed checks](Acceptance-AOA.md#aoa-04-details)**
...
- [ ] **AOA-04 - Native gameplay and migration proof**
  ...
  - **State:** unverified. **Details:** [72 source blocks](Sources-AOA.md#aoa-04); 22 source documents.

**[Open 21 detailed checks](Acceptance-AOA.md#aoa-05-details)**
...
- [ ] **AOA-05 - Clean conversion replay**
  ...
  - **State:** unverified. **Details:** [52 source blocks](Sources-AOA.md#aoa-05); 21 source documents.

**[Open 90 detailed checks](Acceptance-AOA.md#aoa-06-details)**
...
- [ ] **AOA-06 - AoA delivered through the studio**
  ...
  - **State:** unverified. **Details:** [328 source blocks](Sources-AOA.md#aoa-06); 24 source documents.
...
- [ ] **UX-01 - Four-action Home**
  ...
  - **State:** unverified. **Details:** [65 source blocks](Sources-UX.md#ux-01); 18 source documents.
...
- [ ] **UX-02 - One contextual workbench**
  ...
  - **State:** unverified. **Details:** [49 source blocks](Sources-UX.md#ux-02); 17 source documents.
...
- [ ] **UX-04 - Discoverable contextual actions**
  ...
  - **State:** unverified. **Details:** [10 source blocks](Sources-UX.md#ux-04); 8 source documents.

**[Open 40 detailed checks](Acceptance-UX.md#ux-05-details)**
...
- [ ] **UX-05 - Honest progress and live findings**
  ...
  - **State:** unverified. **Details:** [82 source blocks](Sources-UX.md#ux-05); 17 source documents.

**[Open 10 detailed checks](Acceptance-UX.md#ux-06-details)**
...
- [ ] **UX-06 - Reliable editing and recovery**
  ...
  - **State:** unverified. **Details:** [14 source blocks](Sources-UX.md#ux-06); 5 source documents.

**[Open 45 detailed checks](Acceptance-UX.md#ux-07-details)**
...
- [ ] **UX-07 - Large-data and bulk usability**
  ...
  - **State:** unverified. **Details:** [57 source blocks](Sources-UX.md#ux-07); 13 source documents.
...
**[Open 39 detailed checks](Acceptance-UX.md#ux-09-details)**
...
- [ ] **UX-09 - First-launch and update experience**
  ...
  - **State:** unverified. **Details:** [56 source blocks](Sources-UX.md#ux-09); 7 source documents.

**[Open 19 detailed checks](Acceptance-UX.md#ux-10-details)**
...
- [ ] **UX-10 - Real-user journey acceptance**
  ...
  - **State:** unverified. **Details:** [24 source blocks](Sources-UX.md#ux-10); 19 source documents.

## Authoring and real assets

[Visual creation and expert code operate on the same editable project.](Creation-and-Assets.md)

**[Open 65 detailed checks](Acceptance-MAKE.md#make-01-details)**
...
- [ ] **MAKE-01 - Arbitrary native mod creation**
  ...
  - **State:** unverified. **Details:** [111 source blocks](Sources-MAKE.md#make-01); 26 source documents.

**[Open 38 detailed checks](Acceptance-MAKE.md#make-02-details)**
...
- [ ] **MAKE-02 - Safe visual and code round-tripping**
  ...
  - **State:** unverified. **Details:** [66 source blocks](Sources-MAKE.md#make-02); 18 source documents.
...
- [ ] **MAKE-05 - Recipes, loot, tags and data editing**
  ...
  - **State:** unverified. **Details:** [19 source blocks](Sources-MAKE.md#make-05); 14 source documents.

**[Open 39 detailed checks](Acceptance-MAKE.md#make-06-details)**
...
**[Open 17 detailed checks](Acceptance-MAKE.md#make-08-details)**
...
- [ ] **MAKE-08 - Animation, Molang, effects and audio**
  ...
  - **State:** unverified. **Details:** [30 source blocks](Sources-MAKE.md#make-08); 12 source documents.
...
- [ ] **MAKE-11 - Real preview and native comparison**
  ...
  - **State:** unverified. **Details:** [32 source blocks](Sources-MAKE.md#make-11); 17 source documents.

## Universal conversion engine

[One semantic project; the strongest proven backend for each real target.](Conversion.md)

**[Open 110 detailed checks](Acceptance-PORT.md#port-01-details)**
...
- [ ] **PORT-01 - Input and source authority**
  ...
  - **State:** unverified. **Details:** [201 source blocks](Sources-PORT.md#port-01); 27 source documents.

**[Open 7 detailed checks](Acceptance-PORT.md#port-02-details)**
...
- [ ] **PORT-02 - Universal semantic representation**
  ...
  - **State:** unverified. **Details:** [48 source blocks](Sources-PORT.md#port-02); 19 source documents.

**[Open 110 detailed checks](Acceptance-PORT.md#port-03-details)**
...
- [ ] **PORT-03 - Live version and toolchain atlas**
  ...
  - **State:** unverified. **Details:** [188 source blocks](Sources-PORT.md#port-03); 28 source documents.

**[Open 46 detailed checks](Acceptance-PORT.md#port-04-details)**
...
- [ ] **PORT-04 - Exact mappings and symbol truth**
  ...
  - **State:** unverified. **Details:** [59 source blocks](Sources-PORT.md#port-04); 22 source documents.

**[Open 73 detailed checks](Acceptance-PORT.md#port-05-details)**
...
- [ ] **PORT-05 - Source migration and semantic repair**
  ...
  - **State:** unverified. **Details:** [131 source blocks](Sources-PORT.md#port-05); 30 source documents.

**[Open 52 detailed checks](Acceptance-PORT.md#port-06-details)**
...
**[Open 47 detailed checks](Acceptance-PORT.md#port-07-details)**
...
- [ ] **PORT-07 - JAR recovery and binary repair**
  ...
  - **State:** unverified. **Details:** [75 source blocks](Sources-PORT.md#port-07); 20 source documents.
...
- [ ] **PORT-08 - Modern and historical build matrix**
  ...
  - **State:** unverified. **Details:** [89 source blocks](Sources-PORT.md#port-08); 17 source documents.

**[Open 64 detailed checks](Acceptance-PORT.md#port-09-details)**
...
- [ ] **PORT-09 - Native loader and compatibility modes**
  ...
  - **State:** unverified. **Details:** [109 source blocks](Sources-PORT.md#port-09); 25 source documents.

**[Open 59 detailed checks](Acceptance-PORT.md#port-10-details)**
...
- [ ] **PORT-10 - Complete cross-edition conversion**
  ...
  - **State:** unverified. **Details:** [135 source blocks](Sources-PORT.md#port-10); 23 source documents.

**[Open 47 detailed checks](Acceptance-PORT.md#port-11-details)**
...
- [ ] **PORT-11 - Authorized server content to native mod**
  ...
  - **State:** unverified. **Details:** [116 source blocks](Sources-PORT.md#port-11); 28 source documents.

**[Open 19 detailed checks](Acceptance-PORT.md#port-12-details)**
...
- [ ] **PORT-12 - Incremental matrix and packaging**
  ...
  - **State:** unverified. **Details:** [30 source blocks](Sources-PORT.md#port-12); 12 source documents.

**[Open 49 detailed checks](Acceptance-PORT.md#port-13-details)**
...
- [ ] **PORT-13 - Conversion parity and clean replay**
  ...
  - **State:** unverified. **Details:** [77 source blocks](Sources-PORT.md#port-13); 22 source documents.
...
- [ ] **DEP-05 - Canonical identity and action registry**
  ...
  - **State:** unverified. **Details:** [116 source blocks](Sources-DEP.md#dep-05); 27 source documents.
...
[Fix the causal owner, retain content, and prove the repaired result.](Repair-and-Diagnostics.md)

**[Open 45 detailed checks](Acceptance-FIX.md#fix-01-details)**
...
**[Open 90 detailed checks](Acceptance-FIX.md#fix-03-details)**
...
- [ ] **FIX-03 - Crash, linkage, data and configuration repair**
  ...
  - **State:** unverified. **Details:** [155 source blocks](Sources-FIX.md#fix-03); 27 source documents.
...
- [ ] **FIX-06 - Black Box incident timeline**
  - **Accept:** Owned bounded rolling evidence, meaningful triggers and cross-tool timeline preserve causal context with export/privacy controls; not a hidden perpetual patching watchdog.
  - **State:** unverified. **Details:** [37 source blocks](Sources-FIX.md#fix-06); 10 source documents.

**[Open 27 detailed checks](Acceptance-FIX.md#fix-07-details)**

<a id="fix-07"></a>
- [ ] **FIX-07 - Dependency-safe bisect and reproducer**
  - **Accept:** Isolate faults using dependency closure, controlled scenarios and delta debugging, retain source content and deliver a working minimized reproduction with provenance.
  - **State:** unverified. **Details:** [36 source blocks](Sources-FIX.md#fix-07); 8 source documents.

**[Open 4 detailed checks](Acceptance-FIX.md#fix-08-details)**

<a id="fix-08"></a>
- [ ] **FIX-08 - Generalized repair knowledge**
  - **Accept:** Every nontrivial verified fix becomes a scoped reusable transformation/incident recipe with negative regressions, applicability/invalidation and clean replay; no hidden hand-patched outputs.
  - **State:** unverified. **Details:** [10 source blocks](Sources-FIX.md#fix-08); 10 source documents.
...
**[Open 118 detailed checks](Acceptance-TEST.md#test-03-details)**
...
- [ ] **TEST-03 - Runtime supervision and automation**
  ...
  - **State:** unverified. **Details:** [203 source blocks](Sources-TEST.md#test-03); 24 source documents.
...
**[Open 40 detailed checks](Acceptance-TEST.md#test-05-details)**
...
- [ ] **TEST-05 - Artifact-bound native proof**
  ...
  - **State:** unverified. **Details:** [103 source blocks](Sources-TEST.md#test-05); 28 source documents.
...
- [ ] **TEST-07 - Results and repeatability**
  ...
  - **State:** unverified. **Details:** [23 source blocks](Sources-TEST.md#test-07); 13 source documents.

**[Open 9 detailed checks](Acceptance-TEST.md#test-08-details)**
...
**[Open 84 detailed checks](Acceptance-LIB.md#lib-01-details)**
...
- [ ] **LIB-01 - Broad source-aware discovery**
  ...
  - **State:** unverified. **Details:** [85 source blocks](Sources-LIB.md#lib-01); 16 source documents.

**[Open 64 detailed checks](Acceptance-LIB.md#lib-02-details)**
...
- [ ] **LIB-02 - Correct premium media and trailers**
  ...
  - **State:** unverified. **Details:** [91 source blocks](Sources-LIB.md#lib-02); 15 source documents.

**[Open 71 detailed checks](Acceptance-LIB.md#lib-03-details)**
...
- [ ] **LIB-03 - Real embedded browser**
  ...
  - **State:** unverified. **Details:** [90 source blocks](Sources-LIB.md#lib-03); 12 source documents.

**[Open 58 detailed checks](Acceptance-LIB.md#lib-04-details)**
...
- [ ] **LIB-04 - Catalog-to-instance bridge**
  ...
  - **State:** unverified. **Details:** [74 source blocks](Sources-LIB.md#lib-04); 22 source documents.

**[Open 138 detailed checks](Acceptance-LIB.md#lib-05-details)**
...
- [ ] **LIB-05 - Dedicated Favorites workspace**
  ...
  - **State:** unverified. **Details:** [156 source blocks](Sources-LIB.md#lib-05); 9 source documents.

**[Open 85 detailed checks](Acceptance-LIB.md#lib-06-details)**
...
- [ ] **LIB-06 - Content lifecycle and provenance**
  ...
  - **State:** unverified. **Details:** [129 source blocks](Sources-LIB.md#lib-06); 24 source documents.

**[Open 14 detailed checks](Acceptance-LIB.md#lib-07-details)**
...
- [ ] **LIB-07 - Exact versions, freeze and upgrades**
  ...
  - **State:** unverified. **Details:** [18 source blocks](Sources-LIB.md#lib-07); 8 source documents.

**[Open 72 detailed checks](Acceptance-LIB.md#lib-08-details)**
...
- [ ] **LIB-08 - Provider downloads and account recovery**
  ...
  - **State:** unverified. **Details:** [86 source blocks](Sources-LIB.md#lib-08); 15 source documents.
...
- [ ] **LIB-09 - Pack and research interchange**
  ...
  - **State:** unverified. **Details:** [128 source blocks](Sources-LIB.md#lib-09); 18 source documents.

## Launcher, accounts and instances

[Keep the existing launcher and catalogue working while the studio grows.](Launcher-and-Instances.md)

**[Open 54 detailed checks](Acceptance-PLAY.md#play-01-details)**
...
- [ ] **PLAY-01 - External-launcher connection in place**
  ...
  - **State:** unverified. **Details:** [136 source blocks](Sources-PLAY.md#play-01); 17 source documents.

**[Open 59 detailed checks](Acceptance-PLAY.md#play-02-details)**
...
- [ ] **PLAY-02 - Instance creation and organization**
  ...
  - **State:** unverified. **Details:** [87 source blocks](Sources-PLAY.md#play-02); 14 source documents.
...
- [ ] **PLAY-05 - Instance update and maintenance**
  ...
  - **State:** unverified. **Details:** [35 source blocks](Sources-PLAY.md#play-05); 9 source documents.
...
[Turn obscure settings and conflicts into clear, reversible actions.](Configuration-and-Hotkeys.md)

**[Open 16 detailed checks](Acceptance-CONFIG.md#config-01-details)**
...
**[Open 28 detailed checks](Acceptance-CONFIG.md#config-02-details)**
...
- [ ] **CONFIG-02 - Config profiles, overlays and repair**
  ...
  - **State:** unverified. **Details:** [53 source blocks](Sources-CONFIG.md#config-02); 19 source documents.

**[Open 8 detailed checks](Acceptance-CONFIG.md#config-03-details)**
...
- [ ] **CONFIG-03 - Dedicated Hotkeys top-level tab**
  ...
  - **State:** unverified. **Details:** [30 source blocks](Sources-CONFIG.md#config-03); 4 source documents.

**[Open 51 detailed checks](Acceptance-CONFIG.md#config-04-details)**
...
- [ ] **CONFIG-04 - Data, functions and command debugger**
  ...
  - **State:** unverified. **Details:** [101 source blocks](Sources-CONFIG.md#config-04); 12 source documents.
...
- [ ] **CONFIG-06 - Progression and softlock intelligence**
  - **Accept:** Analyze quest/recipe/loot/unlock dependencies, detect reachability and progression traps, explain causes and verify fixes in actual gameplay.
  - **State:** unverified. **Details:** [30 source blocks](Sources-CONFIG.md#config-06); 6 source documents.

## Worlds, servers and migration

[Preserve Forever Worlds, external ownership and every meaningful migration field.](Worlds-and-Servers.md)

**[Open 84 detailed checks](Acceptance-WORLD.md#world-01-details)**
...
- [ ] **WORLD-01 - World browser and safe editing**
  ...
  - **State:** unverified. **Details:** [142 source blocks](Sources-WORLD.md#world-01); 18 source documents.
...
- [ ] **WORLD-03 - Whole-modpack migration**
  ...
  - **State:** unverified. **Details:** [44 source blocks](Sources-WORLD.md#world-03); 18 source documents.

**[Open 56 detailed checks](Acceptance-WORLD.md#world-04-details)**
...
- [ ] **WORLD-04 - Cross-edition world conversion**
  ...
  - **State:** unverified. **Details:** [70 source blocks](Sources-WORLD.md#world-04); 16 source documents.

**[Open 89 detailed checks](Acceptance-WORLD.md#world-05-details)**
...
- [ ] **WORLD-06 - Network, proxy and plugin semantics**
  ...
  - **State:** unverified. **Details:** [111 source blocks](Sources-WORLD.md#world-06); 20 source documents.

## AI operator and evidence brain

[One job and one evidence model, regardless of who drives the interface.](AI-and-Evidence.md)

**[Open 57 detailed checks](Acceptance-AI.md#ai-01-details)**
...
- [ ] **AI-01 - Authorized provider lanes**
  ...
  - **State:** unverified. **Details:** [144 source blocks](Sources-AI.md#ai-01); 25 source documents.

**[Open 27 detailed checks](Acceptance-AI.md#ai-02-details)**
...
- [ ] **AI-06 - Evidence Brain promotion and rollback**
  ...
  - **State:** unverified. **Details:** [245 source blocks](Sources-AI.md#ai-06); 28 source documents.
...
- [ ] **AI-07 - AI evaluation and observability**
  ...
  - **State:** unverified. **Details:** [135 source blocks](Sources-AI.md#ai-07); 22 source documents.

## Knowledge and compatibility

[Explanations and documentation connect directly to the working project.](Knowledge-and-Compatibility.md)

**[Open 17 detailed checks](Acceptance-KNOW.md#know-01-details)**
...
- [ ] **KNOW-01 - Premium in-app Wiki**
  ...
  - **State:** unverified. **Details:** [54 source blocks](Sources-KNOW.md#know-01); 16 source documents.

**[Open 20 detailed checks](Acceptance-KNOW.md#know-02-details)**
...
- [ ] **KNOW-02 - Why installed and contextual explanations**
  ...
  - **State:** unverified. **Details:** [41 source blocks](Sources-KNOW.md#know-02); 19 source documents.

**[Open 15 detailed checks](Acceptance-KNOW.md#know-03-details)**
...
**[Open 61 detailed checks](Acceptance-KNOW.md#know-04-details)**
...
- [ ] **KNOW-04 - Compatibility execution and matrix**
  ...
  - **State:** unverified. **Details:** [141 source blocks](Sources-KNOW.md#know-04); 26 source documents.

**[Open 8 detailed checks](Acceptance-KNOW.md#know-05-details)**

<a id="know-05"></a>
- [ ] **KNOW-05 - Source refresh and typed extensions**
  - **Accept:** Keep provider/tool/schema/contract registries extensible, versioned, cached and on-demand with pagination/rights/health/provenance and unknown-versus-absent states; no hidden polling watchdog.
  - **State:** unverified. **Details:** [15 source blocks](Sources-KNOW.md#know-05); 12 source documents.

## Security, preservation and release
...
- [ ] **SHIP-01 - Supply-chain and untrusted input safety**
  ...
  - **State:** unverified. **Details:** [144 source blocks](Sources-SHIP.md#ship-01); 28 source documents.

**[Open 47 detailed checks](Acceptance-SHIP.md#ship-02-details)**
...
**[Open 25 detailed checks](Acceptance-SHIP.md#ship-05-details)**
...
- [ ] **SHIP-05 - Continuity, convergence and honest status**
  ...
  - **State:** unverified. **Details:** [48 source blocks](Sources-SHIP.md#ship-05); 22 source documents.

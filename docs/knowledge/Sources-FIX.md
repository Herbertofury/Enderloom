...
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G03 · GATE — User/profile state survives updates and restarts /   GDN-020 · Stop Enderloom upgrades from losing the user&#x27;s profile](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L131-L131) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G06 · GATE — Files, logs, and guided installs act like desktop software /   GDN-050 · Add a first-class Logs tab](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L220-L227) - ENDERLOOM_GET_DONE_NOW_QOL.md; 2 distinct blocks.

...
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G06 · GATE — Files, logs, and guided installs act like desktop software /   GDN-051 · Fix “Show file” — reveal and select, do not open/execute](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L233-L233) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.
...
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G04 · GATE — Instance launching and presentation are polished /   GDN-032 · Compact the oversized instance hero/header](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L161-L164) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.
...
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G04 · GATE — Instance launching and presentation are polished](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L135-L135) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G04 · GATE — Instance launching and presentation are polished /   GDN-032 · Compact the oversized instance hero/header](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L159-L159) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G04 · GATE — Instance launching and presentation are polished /   GDN-033 · Redesign the top bar to be denser, sleeker, and more coherent](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L168-L168) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G06 · GATE — Files, logs, and guided installs act like desktop software](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L214-L214) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G06 · GATE — Files, logs, and guided installs act like desktop software /   GDN-053 · Stop classifying random JSON/ZIP files as addons](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L258-L269) - ENDERLOOM_GET_DONE_NOW_QOL.md; 3 distinct blocks.
...
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G03 · GATE — User/profile state survives updates and restarts](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L111-L111) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G03 · GATE — User/profile state survives updates and restarts /   GDN-020 · Stop Enderloom upgrades from losing the user&#x27;s profile](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L117-L117) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G06 · GATE — Files, logs, and guided installs act like desktop software /   GDN-052 · One universal guided-install engine](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L254-L254) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.
...
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue / Done when](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L331-L331) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G04 · GATE — Instance launching and presentation are polished /   GDN-033 · Redesign the top bar to be denser, sleeker, and more coherent](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L166-L179) - ENDERLOOM_GET_DONE_NOW_QOL.md; 2 distinct blocks.
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G06 · GATE — Files, logs, and guided installs act like desktop software /   GDN-051 · Fix “Show file” — reveal and select, do not open/execute](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L229-L231) - ENDERLOOM_GET_DONE_NOW_QOL.md; 2 distinct blocks.
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G06 · GATE — Files, logs, and guided installs act like desktop software /   GDN-053 · Stop classifying random JSON/ZIP files as addons](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L260-L267) - ENDERLOOM_GET_DONE_NOW_QOL.md; 2 distinct blocks.
...
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue / Non-negotiable behavior](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L14-L14) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.
...
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G03 · GATE — User/profile state survives updates and restarts /   GDN-020 · Stop Enderloom upgrades from losing the user&#x27;s profile](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L113-L113) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.
- [Enderloom — GET DONE NOW: Core UX / QoL Repair Queue /   GDN-G08 · GATE — Whole queue convergence and runtime proof /   GDN-072 · Packaged-app workflow proof](https://github.com/Herbertofury/Enderloom/blob/main/docs/ENDERLOOM_GET_DONE_NOW_QOL.md#L312-L312) - ENDERLOOM_GET_DONE_NOW_QOL.md; 1 distinct blocks.

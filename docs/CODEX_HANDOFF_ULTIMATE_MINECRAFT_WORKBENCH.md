...
6. `docs/AI_AUTONOMOUS_REPAIR_LOOP_SPEC.md`
7. `docs/PREMIUM_TESTING_LAB_SPEC.md`
8. `docs/PREMIUM_TESTING_FULL_CLI_CHECKLIST.md`
9. `docs/CODEX_HANDOFF_PREMIUM_TESTING_CLI.md`
10. GitHub issue #1 — existing Performance Lab continuity
11. GitHub issue #3 — Ultimate Minecraft Workbench expansion tracker
...
CLI/Testing expansion should continue through the same domain/capability registry rather than a second CLI architecture.

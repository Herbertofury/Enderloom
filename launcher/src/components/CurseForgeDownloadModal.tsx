  ...
  return (
    ...
    >
      <ModalHeader
        ...
        subtitle="CurseForge lets authors block automatic downloads. Fetch these in your browser and Enderloom takes it from there."
        icon={
      ...
      <div className="shrink-0 border-b border-border-soft px-5 py-3.5">
        <div className="flex items-baseline justify-between gap-4">
          ...
          <span className="text-[11px] text-content-faint">
            Enderloom watches Downloads and checks the name, size and checksum
          </span>
        </div>

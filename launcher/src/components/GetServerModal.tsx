    ...
    <Modal open onClose={onClose}>
      ...
      <div className="flex flex-col gap-3 px-5 py-4">
        ...
        <p className="text-[11px] leading-relaxed text-content-muted">
          {file.url
            ? "Enderloom unpacks this pack into a new server folder and reads what it finds to work out the software and version."
            : "This author does not allow Enderloom to download the file, so it opens in your browser and Enderloom picks it up from your downloads folder."}
        </p>

  ...
  const eulaCheckbox = (
    <label className="flex cursor-pointer items-start gap-2.5 rounded-xl border border-border-soft bg-surface-2/50 px-4 py-3">
      ...
      <span className="text-[11px] leading-relaxed text-content-muted">
        ...
        . Enderloom writes eula.txt for you once you accept, and a server will not start without it.
      </span>
    </label>
  );
      ...
      {mode === null && (
        <div className="flex flex-col gap-2.5 px-5 py-5">
          <Choice
            ...
            description="Pick a version and a flavour, Enderloom downloads and sets it up."
            onClick={() => setMode("new")}
          />
          <Choice
            icon={FolderInput}
            title="Import an existing folder"
            description="Keep the folder where it is and manage it from Enderloom."
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                ...
                <span className="mt-0.5 block text-[11px] text-content-muted">
                  {folder
                    ? "Enderloom reads this folder in place and never moves it."

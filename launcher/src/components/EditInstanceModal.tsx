  ...
  return (
    <Modal open onClose={onClose} size="xl" className="h-[min(680px,calc(100vh-48px))]">
            ...
            {!instance.pack_project_id && (
              ...
              >
                <SettingRow
                  ...
                  hint="Link one if this instance came from a pack, and Enderloom will offer its updates"
                  stacked
                >
      ...
      <ConfirmDialog
        ...
        description="Its mods and configs stay exactly where they are, but they become yours to manage. Enderloom will no longer offer pack updates for this instance."
        confirmLabel="Unlink"
        onConfirm={async () => {
          try {

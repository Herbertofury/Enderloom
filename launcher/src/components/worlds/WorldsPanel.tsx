  ...
  if (!inspection && !inspecting) {
    return (
      <UploadModal
        ...
        onClose={onClose}
        title="Import worlds"
        subtitle={`A save folder with level.dat in it, or a zip holding one or more worlds. Enderloom copies them straight into ${instance.name}.`}
        extensions={["zip"]}
  ...
  return (
    ...
    >
      <ModalHeader
        ...
        title="Import worlds"
        subtitle={`Enderloom copies worlds directly into ${instance.name}. Your files never pass through the webview.`}
        icon={

        ...
        <EmptyState
          ...
          description={
            stats.lifetime_secs > 0
              ? `Enderloom has ${formatDuration(stats.lifetime_secs)} of playtime on record from before it tracked individual sessions. The breakdowns start filling in with your next launch.`

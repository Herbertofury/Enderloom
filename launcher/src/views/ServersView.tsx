  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <ConfirmDialog
        ...
        description={
          removing?.managed
            ? "Enderloom deletes this server folder, including its worlds. This cannot be undone."
            : "Enderloom forgets this server. The folder and everything in it stays where it is."
        }
        confirmLabel="Remove"

...
const ACCENT_MODES: Array<{ id: AccentMode; label: string; hint: string }> = [
  ...
  { id: "default", label: "Enderloom orange", hint: "The colour Enderloom ships with" },
];
  ...
  const applyUpdate = async () => {
    ...
    if (appUpdateStatus?.phase === "ready") {
      try {
        ...
        toast.error("Enderloom could not restart for the update", {
          description: String(error),
        });
      }
      return;
    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-8 py-6">
        ...
        <section className="relative mb-6 overflow-hidden rounded-2xl border border-border-soft bg-surface-2/60 p-7">
          ...
          <Section
            title="Updates"
            description="Choose how Enderloom looks for new launcher versions."
          >
            <Row
        ...
        {tab === "java" && (
          ...
          <Section
            title="Java"
            description="Enderloom picks a matching runtime per version automatically. Pin one here to override everywhere."
          >
            <Row
              label="Runtime"
              hint={
            ...
            <Row
              ...
              hint="Download Eclipse Temurin into Enderloom without changing system Java"
              stacked
            >
          ...
          <div className="min-w-[24rem] flex-1 lg:sticky lg:top-2">
            <Section
              ...
              description={
                preview?.pinned
                  ? "What Enderloom will run. The pinned runtime above is used as is."
                  : "What Enderloom will run. With auto-detect, the runtime is chosen per version."
              }
            >
                ...
                {preview ? (
                  <code className="selectable block font-mono text-[11px] leading-relaxed">
                    ...
                    <span className="block whitespace-pre-wrap py-1 pl-4 text-content-faint/70">
                      classpath, natives path and main class are added here by Enderloom
                    </span>
        ...
        {tab === "game" && (
          ...
          <Section
            ...
            description="Commands Enderloom runs for you. Placeholders like {{instance_name}} and {{game_dir}} work here."
          >
            <Row
        ...
        {tab === "servers" && (
          ...
          <Section title="Shutting down" description="What happens to a running server.">
            <Row label="When Enderloom closes" stacked>
              <div className="w-full">
                <Select
            ...
            {draft.server_shutdown === "leave" && (
              <Row
                label="Left running"
                hint="Enderloom reattaches on the next start, but the console cannot take commands until you restart the server from Enderloom"
                stacked
              />
            )}
          </Section>
        ...
        {tab === "network" && (
          ...
          <Section
            title="Proxy"
            description="Routes every request Enderloom makes. The game itself is not affected."
          >
          ...
          <Section
            title="Requests"
            description="How patient Enderloom is with slow or flaky servers."
          >
        ...
        {tab === "appearance" && (
          ...
          <Section
            title="Accent colour"
            description="The colour Enderloom uses for buttons, highlights and progress."
          >
          ...
          <Section
            ...
            description="What Enderloom uses to say something went well, needs attention, or failed."
          >
            <ColorField
              label="Success"
          ...
          <Section title="Behaviour" description="How Enderloom acts while you use it.">
            <Row
            ...
            <Row
              ...
              hint="Gets Enderloom out of the way on launch and brings it back when the last instance closes"
            >
              <Toggle
                label="Minimize while the game runs"
        ...
        {tab === "resources" && (
          ...
          <Section
            title="Downloads"
            description="How hard Enderloom pulls while installing."
          >
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-4 gap-y-3 rounded-2xl border border-border-soft bg-surface-2/60 px-4 py-3">
              ...
              <button
                ...
                title="Moves instances, accounts, skins and settings into a timestamped recovery set, then restarts into setup"
      ...
      <ConfirmDialog
        open={resetting}
        title="Reset Enderloom?"
        description="Instances, worlds, mods, configs, accounts, skins and settings move into a timestamped recovery folder instead of being deleted. Enderloom then restarts into first-time setup."
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            <span className="block text-xs font-medium text-content">
              Also quarantine downloaded game files
            </span>

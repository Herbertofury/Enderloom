...
pub async fn auth_begin(app: AppHandle, state: State<'_, AppState>) -> Result<DeviceCodeInfo> {
    ...
    auth_begin_core(&state, sink).await
}

pub(crate) async fn auth_begin_core(
    state: &AppState,
...
pub fn set_active_account(state: State<AppState>, account_id: String) -> Result<()> {
    set_active_account_core(&state, &account_id)
}

pub(crate) fn set_active_account_core(state: &AppState, account_id: &str) -> Result<()> {
...
pub fn remove_account(state: State<AppState>, account_id: String) -> Result<()> {
    remove_account_core(&state, &account_id)
}

pub(crate) fn remove_account_core(state: &AppState, account_id: &str) -> Result<()> {

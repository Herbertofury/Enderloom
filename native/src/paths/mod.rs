...
impl DataRoot {
    ...
    pub fn summary(self) -> &'static str {
        match self {
            ...
            DataRoot::Servers => "Worlds, plugins and configs for the servers Enderloom hosts.",
            DataRoot::Versions => "The client jars Enderloom downloads for each Minecraft version.",
            ...
            DataRoot::Runtimes => "Java builds Enderloom installed for you.",
...
pub struct Paths {
    ...
    instance_links: Arc<RwLock<BTreeMap<String, PathBuf>>>,
}
...
impl Paths {
    ...
    pub fn relocated(root: PathBuf, overrides: BTreeMap<DataRoot, PathBuf>) -> Self {
        Self {
            ...
            instance_links: Arc::new(RwLock::new(BTreeMap::new())),
        }
    }
    ...
    pub fn adopt_instance_links(&self, links: Vec<(String, PathBuf)>) {
        ...
        for (id, path) in links {
            ...
            kept.insert(id.to_string(), path);
        }
        *self.instance_links.write().unwrap() = kept;
    }
    ...
    pub fn instance_dir(&self, id: &str) -> PathBuf {
        self.instance_links
            ...
            .get(id)
            .cloned()
            .unwrap_or_else(|| self.instances().join(id))
    }
    ...
    pub fn instance_dir_checked(&self, id: &str) -> Option<PathBuf> {
        ...
        if !self.instance_links.read().unwrap().contains_key(id)
            && dir.parent() != Some(self.instances().as_path())
        {
            return None;
        }
        Some(dir)

...
/// Launcher bookkeeping that means nothing once the instance lives in Enderloom.
...
/// Enderloom fills in when it installs a modpack itself.
...
/// ATLauncher parks turned-off mods in a sibling folder; Enderloom marks them in place.
